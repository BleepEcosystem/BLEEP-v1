...
impl AIHooks {
    ...
    pub fn analyze_historical_data(
        ...
        info!(
            ...
            analysis.metric_name, analysis.trend
        );
    ...
    pub fn get_weighted_advisory(
        ...
        let weight = ai_reputation
            .get_reputation(&proposal.ai_model.model_id)
